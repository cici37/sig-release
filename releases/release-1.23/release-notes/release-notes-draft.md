...
Since 1.21, Kubernetes clusters are enabled to support dual-stack networking by default. In 1.23, the `IPv6DualStack` feature gate is removed. The use of dual-stack networking is not mandatory. 
...
### Structured logging graduated to Beta
...
If CSI Migration is working properly, Kubernetes end users should not notice a difference. 
